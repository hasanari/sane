...
class FrameHandler():
	...
	def load_annotation(self, drivename, fname, settingsControls, dtype='object'):
		fname = settingsControls["AnnotatorId"]+'.'+fname.split(".")[0] + ".json"
		try:
	...
	def save_annotation(self, drivename, fname, json_str, settingsControls):
		"""
